...
const int open_value = 857;  // giá trị để extension mở ra
const int close_value = 1880; // giá trị để extension đóng lại
...
const int time_to_open = 2000 ;//thời gian để mở hoàn toàn extension, đo bằng tay?
const int time_to_close = 2000; // thời gian để đóng hoàn toàn extension, đo bằng tay?
